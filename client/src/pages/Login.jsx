        ...
        >
            ...
            <header className="bg-[#0f172a]/95 backdrop-blur-xl h-20 flex items-center justify-between px-6 sm:px-12 text-white shadow-2xl z-50 border-b border-white/10">
                ...
                <div className="flex gap-5 font-bold">
                    <Link
                        to="/register"
                        className="px-5 py-2 rounded-xl border-2 border-white/10 hover:border-[#6366f1] hover:bg-[#6366f1]/10 transition-all text-slate-200 hover:text-white flex items-center gap-2"
                    >
                        Create Account
                    </Link>
                    <button className="px-7 py-2 rounded-xl bg-gradient-to-r from-[#6366f1] to-[#1e40af] text-white shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:shadow-[0_0_25px_rgba(99,102,241,0.5)] transform hover:-translate-y-0.5 transition-all">
                        Login
                    </button>
                </div>
            </header>
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-4 relative">
                <div className="w-full max-w-md glass p-8 rounded-2xl shadow-2xl">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold text-pat-dark">Sign In</h1>
                        <p className="text-slate-600 mt-2 font-medium">Access your PAT portal</p>
                    </div>
                    ...
                    <div className="mt-8 text-center text-sm">
                        ...
                        <Link to="/register" className="text-pat-blue font-bold hover:underline">Create Account</Link>
                    </div>
                </div>
            </main>
